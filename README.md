This project loops through a list of sculpture objects and creates a new object for each sculpture where the values represent the string lengths of the original object’s properties.

Output Object (sculptureListLengths)

Below is the required output included in this assignment:
